                    ...
                    <div className="agileinfo-ads-display col-md-9">
                        <div className="wrapper">
                                ...
                                <div className="col-md-4 product-men">
                                    <div className="men-pro-item simpleCart_shelfItem">
                                        <div className="men-thumb-item">
                                            <img src="http://book.framgia.vn/images/book_thumb_default.jpg" alt="" />
                            ...
                            <div className="product-sec1 product-sec2">
                                ...
                                <h3 className="w3l-nut-middle">Read & Feel Books</h3>
                                <div className="col-xs-5 bg-right-nut">
                                    <img src="http://api-book.framgia.vn/image//2018/03/book/veembangmaunoinho.jpg?p=thumbnail_web&s=c545ba92c83df55c8200181a91edf7aa" alt="" />
                                </div>
                                <div className="clearfix"></div>
                            </div>

                            <div className="product-sec1">
                                <h3 className="heading-tittle">Top Rating</h3>
                                <div className="col-md-4 product-men">
                                    <div className="men-pro-item simpleCart_shelfItem">
                                        <div className="men-thumb-item">
                                            <img src="http://api-book.framgia.vn/image//2018/03/book/nen-giao-duc-cua-nguoi-giau-a.jpg?p=thumbnail_web&s=90fed494e914bae01c520352dbdb89c6" alt="" />
